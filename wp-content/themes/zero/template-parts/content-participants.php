        ...
        <div class="works-auth_block">
            <div class="works-auth_wrapper">
                ...
                <div class="works-auth_buttons-auth">
                    ...
                    <a rel="nofollow" href="/wp-json/wslu-social-login/type/facebook" class="f-button"><img src="<?= get_template_directory_uri(); ?>/assets/img/icon/fb-icon.svg"> Sign in with FACEBOOK </a>
